...
export function FPSCounter() {
  ...
  return (
    <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-50 bg-gray-900/80 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg border border-gray-700">
